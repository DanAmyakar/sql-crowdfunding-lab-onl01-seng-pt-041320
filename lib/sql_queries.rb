...
=======
  ...
  WHERE pledges.project_id = projects.id GROUP BY projects.title HAVING projects.id  = 
  pledges.project_id Order BY SUM(amount), projects.funding_goal > -1;"
>>>>>>> abe2a4b503ac950a31e9dd0bca3b323683bfb386
end
